...
namespace NHST
{
    ...
    public class WebService1 : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        [ScriptMethod(UseHttpGet = false, ResponseFormat = ResponseFormat.Json)]
        public void Register(string FirstName, string LastName, string Address, string Phone, string Email, string BirthDay, int Gender, string UserName, string Password, string ConfirmPassword, int SaleID)
        {
            var rs = new ResponseClass();
